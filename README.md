...
#### Subrede: 172.16.0.0/24, Subrede range: 172.16.0.1 - 172.16.0.254 (Vem pré-estabelecido de acordo com o IP da LAN, atribuído manulmente no pfSense)
#### Address Pool Range: 172.16.0.130 - 172.16.0.150 (Usado neste exemplo de rede)
#### Servidores DNS: 172.16.0.13 (IP do próprio servidor pfSense, pois também será configurado um servidor DNS)
#### Gateway: 172.16.0.13 (IP do próprio servidor)
#### Domain name: lan (Dominío criado para esta rede)
#### Default lease time: 7200s/2h (Tempo em que o DHCP atribui o IP antes que o clinte precise renovar)
#### Maximum  lease time: 86400s/24h (Tempo máximo em que um cliente pode ficar com IP antes que precise renovar)
#### DHCP Static Mappings 
#### Endereço MAC: 08:00:27:17:ee:9b (Endereço MAC da máquina que vai ser o servidor)
#### Endereço IP: 172.16.0.125 (IP que vai ser amarrado ao servidor)
#### Nome de host: servidor (Nome atribuido ao servidor)
